...
<div className="l-Wrapper">
  ...
  <div className="l-Header">
    ...
    <div className="l-Header-col Contact">
      <div>Seattle, WA</div>
      <div><a className="u-link" href="http://sonjastrieder.com/" target="_blank">76767676666</a></div>
      <div><a className="u-link" href="mailto:sonja.strieder@gmail.com" target="_blank">sonja.strieder@gmail.com</a></div>
    </div>
  </div>
  ...
  <section className="l-Section">
    ...
    <div className="l-Section-content">
                    <p>I specialize in component based HTML/CSS architecture, with a focus on maintainability and scalability,
                        a mobile first approach.I specialize in component based HTML/CSS architecture, with a focus on maintainability and scalability, a mobile first approach.
                        specialize in component based HTML/CSS architecture, with a focus on maintainability and scalability, a mobile first approach.</p>
  ...
  <section className="l-Section">
    ...
    <div className="l-Section-content">
      ...
      <a className="u-link" href="https://www.snaptechnology.co.uk/" target="_blank">Snap Fashion, London</a> (UK) May 2014 - Jul 2016
      <ul>
      ...
      <a className="u-link" href="http://www.johnhenry.net/" target="_blank">JohnHenry, London</a> (UK) Jun 2010 - May 2014
      <ul>
        <li>Working within a team of 16+ I’ve established myself as a front-end developer with a strong focus on web standards,
         semantics, accessibility and progressive enhancement (HTML/CSS).</li>
  ...
  <section className="l-Section">
    ...
    <div className="l-Section-content">
      ...
      <a className="u-link" href="https://www.fh-ooe.at/en/hagenberg-campus/" target="_blank">University of Applied Sciences Campus Hagenberg</a> (AUT) 2006 - 2009
